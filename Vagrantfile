...
# Memory for VirtualBox machine
memory = ENV['VAGRANT_ROS_JADE_MEMORY']  || '2048'
# Number of cpus for VirtualBox machine
cpus =   ENV['VAGRANT_ROS_JADE_CORES']   || '2'
...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    # Customize amount of processor memory:
    vb.cpus = cpus.to_i
  ...
  config.push.define "atlas" do |push|
    push.app = "sorjef/ros-jade-desktop-trusty64"
  end
